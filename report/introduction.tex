...
When talking about the fake runner, I will be referring to a runner that is not actually in race, but rather a runner with speed 1, who I have introduced in order to have a convenient termination criterion for the Geometrical algorithm\footnote{\pref{compGeo}}. \pref{termination} for an elaboration for the reasons behind it.
\end{defi}  
