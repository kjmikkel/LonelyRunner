...
Using this order there is no ambiguity where to place the points, and we also avoid any problems with the edge case where we have (n-1) runners are in the zone \todo{Clarify what this is}


ensure that in the case where 2 
 termination condition \todo{find a better term - this is when there are n \comFin at the same time }
